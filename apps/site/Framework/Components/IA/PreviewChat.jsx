 ...
 * 
 * @param {Object} props
 * @param {Object} props.config - Current IA configuration
 * @param {string} props.config.secretaryName - Secretary name
 * @param {string} props.config.avatar - Secretary avatar URL
 * @param {string} props.config.welcomeMessage - Welcome message
 * @param {string} props.config.tone - Voice tone
 * @param {string} props.config.systemPrompt - System prompt
 * @param {boolean} props.showSystemPrompt - Show system prompt display
