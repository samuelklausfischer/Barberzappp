...
const Finance: React.FC = () => {
  ...
  return (
    <div className="space-y-8 text-[#1A1A1F] animate-in slide-in-from-bottom duration-500">
      <header className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        ...
        <button
          disabled
          title="Em breve"
          className="h-10 cursor-not-allowed rounded-xl bg-[#D4AF37] px-6 font-bold text-[#1A1A1F] opacity-50"
        >
          Exportar - Em breve
        </button>
      </header>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="lg:col-span-2 rounded-2xl bg-white border border-[#E5E7EB] p-8 shadow-[0_8px_24px_rgba(26,26,31,0.04)]">
          <p className="text-[#6B7280] font-bold text-sm uppercase tracking-widest">
            Faturamento estimado
          </p>
          <h2 className="mt-6 text-5xl font-bold tracking-tighter">
        ...
        <div className="rounded-2xl bg-white border border-[#E5E7EB] p-8 flex flex-col justify-between shadow-[0_8px_24px_rgba(26,26,31,0.04)]">
          <p className="text-[#6B7280] font-bold text-sm uppercase tracking-widest">
        ...
        <div className="rounded-2xl bg-white border border-[#E5E7EB] p-8 flex flex-col justify-between shadow-[0_8px_24px_rgba(26,26,31,0.04)]">
          ...
          <h2 className="mt-8 text-3xl font-bold">{loading ? '...' : appointments.length}</h2>
          <p className="text-[#6B7280] text-sm mt-1">Nenhum registro e criado automaticamente.</p>
        </div>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="rounded-2xl bg-white border border-dashed border-[#D1D5DB] p-12 text-center shadow-[0_8px_24px_rgba(26,26,31,0.04)]">
